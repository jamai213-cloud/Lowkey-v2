...
export default function VerificationPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] p-5 page-enter">
      ...
      <div className="max-w-md mx-auto">
        {step === 1 && (
          <div className="glass-card rounded-2xl p-6">
            ...
            <h2 className="text-xl font-heading font-semibold text-white text-center mb-2">Verify Your Identity</h2>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-xl border-2 border-dashed border-white/20 text-center hover:border-purple-500/50 transition-colors cursor-pointer" onClick={simulateVerification}>
                ...
                <p className="text-white/60 text-sm">Click to upload verification photo</p>
                <p className="text-white/25 text-xs mt-1">JPG, PNG up to 10MB</p>
              </div>
              
              <div className="text-sm text-white/25 space-y-2">
        ...
        {step === 2 && (
          <div className="glass-card rounded-2xl p-6 text-center">
            ...
            <h2 className="text-xl font-heading font-semibold text-white mb-2">Processing...</h2>
            <p className="text-white/40">We're reviewing your verification photo.</p>
          </div>
        )}
        ...
        {step === 3 && (
          <div className="glass-card rounded-2xl p-6 text-center">
            ...
            <h2 className="text-xl font-heading font-semibold text-white mb-2">Verified!</h2>
            <p className="text-white/40 mb-6">You now have full access to all LowKey features.</p>
            <button
              onClick={() => router.push('/')}
