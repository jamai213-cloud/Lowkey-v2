...
export default function RadioMiniPlayer() {
  ...
  return (
    <div className="fixed bottom-16 left-0 right-0 z-[100] bg-gradient-to-r from-purple-900/95 to-pink-900/95 backdrop-blur-lg border-t border-white/10 safe-area-bottom shadow-lg shadow-purple-900/50">
